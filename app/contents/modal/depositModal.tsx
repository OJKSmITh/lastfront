...
export const DepositModal = ({token}:IDepositModal) => {
  ...
  return (
    <>
      ...
      <CustomModal isOpen={modalIsOpen} onClose={()=>setModalIsOpen(false)} width={340} height={350} left={17} content={<DepositModalContent token={token as Token } balance={0} from={false}/>}/>
      <CustomModal isOpen={modalIsOpen2} onClose={()=>setModalIsOpen2(false)} width={340} height={350} left={17} content={<WithdrawsingleModalContent token={token as Token } />}/>
    </>
  );
};